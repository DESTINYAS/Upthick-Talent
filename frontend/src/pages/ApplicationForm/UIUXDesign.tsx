      ...
      <form onSubmit={handleSubmit} className="text-2xl font-normal">
        ...
        <div>
          <label className="flex flex-col mb-2" htmlFor="address">
            What area of design are you most proficient in now?
            <select
              id="address"
              name="address"
              placeholder="5+ years"
              ...
              <option value="option3">UX Researcher</option>
            </select>
          </label>

          <label className="flex flex-col mb-2" htmlFor="experience">
        ...
        <div>
          ...
          <label className="flex flex-col mb-2" htmlFor="fellowshipInfo">
            ...
            <select
              ...
              <option value="option17">Others</option>
            </select>
          </label>
        </div>
